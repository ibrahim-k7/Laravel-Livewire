                                ...
                                @forelse($users as $user)
                                    <tr
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center text-sm">
                                                ...
                                                <div>
                                                    ...
                                                    <span
                                                        class="block text-xs text-gray-600 lowercase dark:text-gray-400">{{ $user->username }}</span>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="px-2 py-3 text-xs text-center">
                                            ...
                                            @elseif($user->role_id)
                                                <span
                                                    class="px-2 py-1 font-semibold line-through leading-tight rounded-full {{ $user->role()->withTrashed()->first()->color }}">
                                        ...
                                        <td class="px-2 py-3 text-sm text-center">
                                            ...
                                            @elseif($user->country_id)
                                                <span
                                                    class="line-through">{{ $user->country()->withTrashed()->first()->name }}</span>
                                            @endif
                                        </td>
                                        <td class="px-2 py-3 text-sm text-center">
